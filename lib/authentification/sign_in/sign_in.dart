...
import 'package:education/authentification/sign_in/sign_in_left_side.dart';
import 'package:education/authentification/sign_in/sign_in_right_side.dart';
              ...
              body: Stack(
                children: <Widget>[
                  SizedBox(
                    ...
                    child: const Row(
                      children: <Widget>[
                        Expanded(child: SignInLeftSide()),
                        Expanded(child: SignInRightSide()),
                      ],
                    ),
                  ),
                  Padding(

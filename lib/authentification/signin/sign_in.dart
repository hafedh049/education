...
import 'package:education/authentification/signin/left_half.dart';
import 'package:education/authentification/signin/right_half.dart';
...
class SignIn extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
        body: Padding(
          ...
          child: Stack(
            children: <Widget>[
              SizedBox(height: MediaQuery.of(context).size.height, child: const Row(children: <Widget>[Expanded(child: SignInLeftSide()), SizedBox(width: 40), Expanded(child: SignInRightSide())])),
              Row(
